...
class WishlistViewController: TopMediaViewController, UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UISearchBarDelegate, LoginViewControllerDelegate, MusicPlayerViewControllerDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if !filteredSongs.isEmpty {
            ...
            cell.costLabel.text = String(describing: filteredSongs[indexPath.row].cost)
        }
        else if let wishList = wishList {
            cell.songTitleLabel.text = wishList[indexPath.row].songTitle
            cell.artistNameLabel.text = wishList[indexPath.row].artists
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        // Make sure songs exists/isn't nil
            ...
            sortSongs(from: shared.user!.wishList!)
        }
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        if searchText == "" || wishList == nil {
            filteredSongs = []
        }
        else {
            filteredSongs = wishList!.filter(({ (song) -> Bool in
            ...
            if let destinationVC = segue.destination as? MusicPlayerViewController {
                ...
                if sender is UIBarButtonItem {
                    ...
                    if !filteredSongs.isEmpty {
                        ...
                        destinationVC.songList = self.wishList
                    }
                    destinationVC.currentSongPositionInList = self.shared.currentPositionInList
                }
